...
class _$_TrendingState implements _TrendingState {
  ...
  @override
  String toString() {
    return 'TrendingState(gifs: $gifs, isLoading: $isLoading, isLoadMoreError: $isLoadMoreError, isLoadMoreDone: $isLoadMoreDone)';
  }
...
abstract class _TrendingState implements TrendingState {
  const factory _TrendingState(
      ...
      final bool isLoading,
      final bool isLoadMoreError,
      final bool isLoadMoreDone}) = _$_TrendingState;
